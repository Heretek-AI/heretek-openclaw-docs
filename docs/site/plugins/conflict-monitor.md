...
9. [Triad Integration](#triad-integration)
...
| [Triad Protocol](../architecture/triad.md) | Triad deliberation protocol |
| [Emotional Salience](./emotional-salience.md) | Amygdala functions plugin |
| [A2A Protocol](../architecture/a2a-protocol.md) | Communication protocol |

---

🦞 *So the collective may reason without contradiction.*
